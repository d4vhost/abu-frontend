    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          ...
          <Link
            href="/contacto"
            className="ml-4 bg-abu-corn text-abu-charcoal px-5 py-2 rounded font-semibold text-sm hover:bg-abu-wheat transition-colors flex items-center gap-1"
          >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-abu-green-dark border-t border-white/10 shadow-xl flex flex-col p-4">
          ...
          <Link
            href="/contacto"
            className="mt-4 bg-abu-corn text-abu-charcoal text-center px-5 py-3 rounded font-semibold hover:bg-abu-wheat transition-colors"
            onClick={() => setMobileMenuOpen(false)}
          >
            Contacto
          </Link>
