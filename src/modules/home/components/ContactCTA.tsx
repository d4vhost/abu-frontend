      ...
      <div className="w-full px-6 md:px-10 lg:px-16 text-center max-w-4xl mx-auto relative z-10">
        <Reveal>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            ...
            <Link
              href="/contacto"
              className="inline-flex items-center justify-center gap-2 border border-abu-line text-abu-white px-7 py-3.5 font-semibold text-sm hover:border-abu-gold hover:text-abu-gold transition-all duration-300"
            >
