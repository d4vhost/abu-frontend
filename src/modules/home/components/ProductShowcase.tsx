        ...
        <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" stagger={0.1}>
          {products.map((product) => (
            <StaggerItem key={product.slug}>
              <div className="group bg-abu-surface border border-abu-line hover:border-abu-gold/30 transition-all duration-300 flex flex-col hover:shadow-lg hover:shadow-abu-gold/5 hover:-translate-y-1 h-full">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2 pt-3 border-t border-abu-line">
                    <Link
                      ...
                      className="flex-1 border border-abu-gold/60 text-abu-gold text-center py-2 font-semibold text-xs hover:bg-abu-gold hover:text-abu-bg transition-all duration-200"
                    >
                      Ver ficha
                    </Link>
                    <Link
