...
export default function ProductShowcase() {
 ...
 <div key={product.slug} className="group bg-abu-cream overflow-hidden border border-abu-earth/10 hover:shadow-xl transition-all duration-300 flex flex-col h-full">
 {/* Product Image */}
 ...
 <div className="absolute top-4 left-4 bg-abu-corn text-abu-charcoal text-xs font-bold px-3 py-1 -full">
 {product.stage}
 </div>
 </div>
 ...
 className="flex-1 bg-white border border-abu-green text-abu-green text-center py-2 font-medium text-sm hover:bg-abu-green hover:text-white transition-colors"
 >
 Ver ficha
 </Link>
 <Link 
 href="/contacto"
 className="flex-1 bg-abu-green text-white text-center py-2 font-medium text-sm hover:bg-abu-green-dark transition-colors"
 >
 Cotizar
 </Link>
 </div>
