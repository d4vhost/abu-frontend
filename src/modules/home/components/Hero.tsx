...
export default function Hero() {
  return (
    <section className="relative w-full h-screen min-h-[700px] flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 bg-gradient-to-br from-abu-bg-main/95 via-abu-bg-main/80 to-abu-bg-sec/60" />
      <div className="absolute inset-0 z-10 bg-gradient-to-t from-abu-bg-main via-transparent to-transparent" />
      ...
      <div className="relative z-30 flex-1 flex items-center pt-20">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-3xl lg:pl-12">
            ...
            {/* Headline */}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-abu-text leading-[1.05] tracking-tight mb-6 text-balance">
              Nutrición balanceada para{" "}
              <span className="text-abu-primary">cada etapa</span>{" "}
              de tus aves
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/productos"
                className="inline-flex items-center justify-center gap-2 bg-abu-primary text-abu-bg-main px-8 py-4 font-bold text-base hover:bg-abu-primary-hover transition-colors shadow-lg shadow-abu-primary/20"
              >
                Conocer productos
              ...
              <Link
                href="/contacto"
                className="inline-flex items-center justify-center px-8 py-4 font-bold text-base text-abu-text border border-abu-border hover:border-abu-primary hover:text-abu-primary transition-colors"
              >
