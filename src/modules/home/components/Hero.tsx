...
export default function Hero() {
 ...
 <span className="inline-block px-4 py-1.5 -full bg-abu-corn/20 text-abu-corn text-sm font-semibold tracking-wider mb-6 border border-abu-corn/30">
 ...
 <Link 
 href="/productos" 
 className="bg-abu-corn text-abu-charcoal px-8 py-4 font-bold text-lg hover:bg-abu-wheat transition-colors flex items-center justify-center gap-2"
 >
 Conocer productos <ChevronRight className="w-5 h-5" />
 </Link>
 <Link 
 href="/contacto" 
 className="bg-transparent text-white border-2 border-white/30 px-8 py-4 font-bold text-lg hover:bg-white/10 transition-colors flex items-center justify-center"
 >
