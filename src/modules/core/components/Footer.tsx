...
export default function Footer() {
 return (
 <footer className="bg-abu-green-dark text-abu-cream border-t border-abu-green pt-16 pb-8">
 <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
 {/* Brand */}
 <div>
 <h2 className="text-3xl font-bold text-abu-corn mb-4">A.B.U.</h2>
 <p className="text-abu-cream/80 mb-6 text-sm leading-relaxed">
 ...
 <li key={link.name}>
 <Link href={link.href} className="text-sm text-abu-cream/70 hover:text-abu-corn transition-colors flex items-center gap-1 group">
 ...
 <MapPin className="w-5 h-5 text-abu-corn shrink-0 mt-0.5" />
 <div className="text-sm text-abu-cream/80">
 ...
 <MapPin className="w-5 h-5 text-abu-corn shrink-0 mt-0.5" />
 <div className="text-sm text-abu-cream/80">
 <p className="font-medium text-white">Planta de Procesamiento</p>
 <p>Provincia de Santo Domingo, km 5 vía a Colorados del Búa.</p>
 </div>
 </li>
 <li className="flex items-center gap-3">
 <Phone className="w-5 h-5 text-abu-corn shrink-0" />
 <div className="text-sm text-abu-cream/80">
 ...
 <div className="container mx-auto px-4 md:px-8 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-abu-cream/50">
