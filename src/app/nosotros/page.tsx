...
export default function NosotrosPage() {
 return (
 <Reveal>
 <div className="pt-24 pb-20 bg-abu-bg-main min-h-screen">
 <div className="container mx-auto px-4 md:px-8 max-w-5xl">
 <h1 className="text-4xl md:text-5xl font-bold text-abu-text mb-8">Nuestra Historia</h1>
 
 <div className="prose prose-lg prose-headings:text-abu-text text-abu-text/80">
 <p>
 ...
 <p className="bg-abu-card p-6 border-l-4 border-abu-primary shadow-sm -r-md">
