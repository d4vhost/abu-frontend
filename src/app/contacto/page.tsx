...
export default function ContactoPage() {
 ...
 <div className="bg-abu-cream p-6 border border-abu-earth/10 flex flex-col items-center text-center">
 <div className="w-12 h-12 bg-abu-green -full flex items-center justify-center text-white mb-4">
 ...
 <div className="bg-abu-cream/30 p-8 border border-abu-earth/10 max-w-3xl mx-auto">
 ...
 <input type="text" className="w-full px-4 py-2 bg-white border border-abu-earth/20 focus:outline-none focus:border-abu-green" />
 </div>
 <div>
 ...
 <select className="w-full px-4 py-2 bg-white border border-abu-earth/20 focus:outline-none focus:border-abu-green">
 ...
 <textarea rows={4} className="w-full px-4 py-2 bg-white border border-abu-earth/20 focus:outline-none focus:border-abu-green"></textarea>
 </div>

 <div className="pt-4 text-center">
 <button type="button" className="px-12 bg-abu-corn text-abu-charcoal font-bold py-3 hover:bg-abu-wheat transition-colors">
 Enviar Mensaje
 </button>
 </div>
 </form>
