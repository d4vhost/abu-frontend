    ...
    <div className="pt-24 pb-20 bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-abu-cream p-6 rounded-xl border border-abu-earth/10 flex flex-col items-center text-center">
        ...
        <div className="bg-abu-cream/30 p-8 rounded-2xl border border-abu-earth/10 max-w-3xl mx-auto">
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2 bg-white border border-abu-earth/20 rounded-md focus:outline-none focus:border-abu-green" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select className="w-full px-4 py-2 bg-white border border-abu-earth/20 rounded-md focus:outline-none focus:border-abu-green">
            ...
            <div>
              ...
              <textarea rows={4} className="w-full px-4 py-2 bg-white border border-abu-earth/20 rounded-md focus:outline-none focus:border-abu-green"></textarea>
            </div>

            <div className="pt-4 text-center">
              <button type="button" className="px-12 bg-abu-corn text-abu-charcoal font-bold py-3 rounded-md hover:bg-abu-wheat transition-colors">
                Enviar Mensaje
              </button>
            </div>
          </form>
