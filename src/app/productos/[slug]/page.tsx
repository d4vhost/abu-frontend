...
export default async function ProductDetailPage({ params }: Props) {
 ...
 {/* Image */}
 <div>
 <div className="relative overflow-hidden aspect-square bg-abu-cream border border-abu-earth/10">
 {product.images[0] && (
 ...
 <div className="mb-6">
 <span className="inline-block px-3 py-1 bg-abu-corn/20 text-abu-green-dark text-xs font-bold -full mb-4">
 {product.stage}
 </span>
 ...
 <div className="grid grid-cols-2 gap-4 mb-8 bg-abu-cream/50 p-6 border border-abu-earth/10">
 <div>
 ...
 <Link 
 href="/contacto" 
 className="flex-1 bg-abu-green text-white text-center py-4 font-bold hover:bg-abu-green-dark transition-colors"
 >
